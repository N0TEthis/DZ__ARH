...
Конечно, вот глава 13 «Адресация в стеке протоколов TCP/IP», переписанная в формате Markdown.
...
Конечно, вот глава 14 «Протокол межсетевого взаимодействия IP», переписанная в формате Markdown.
